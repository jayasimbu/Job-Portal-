...
export default function SkillsAnalysis() {
  return (
    ...
    >
      <div className="mt-16 bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-[2.5rem] p-12 shadow-2xl relative overflow-hidden group">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid grid-cols-2 gap-6">
            {[
              ...
              <div key={i} className="p-6 bg-slate-100 dark:bg-slate-800/50 rounded-3xl border border-slate-200 dark:border-slate-700 hover:border-blue-500/50 transition-all ">
