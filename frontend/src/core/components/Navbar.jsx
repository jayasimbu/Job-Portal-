...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-[100] bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-100 dark:border-slate-800">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
           <button className="size-12 rounded-[20px] hover:bg-slate-50 dark:hover:bg-slate-800 flex items-center justify-center text-slate-400 transition-all active:scale-95">
            ...
            <div className="flex items-center gap-4 group relative cursor-pointer">
              ...
              <div className="absolute top-[calc(100%+12px)] right-0 w-[300px] bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-2xl rounded-[32px] opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-all duration-300 z-[110] translate-y-4 group-hover:translate-y-0 overflow-hidden">
                 ...
                 <div className="px-4 pb-4 space-y-1">
                    <Link to={user?.role === 'employer' ? "/platform/employer/profile" : "/platform/jobseeker/profile"} className="flex items-center gap-4 px-5 py-3.5 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-2xl transition-all group/item">
                    ...
                    <Link to="/platform/settings" className="flex items-center gap-4 px-5 py-3.5 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-2xl transition-all group/item">
