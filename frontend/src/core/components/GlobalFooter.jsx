      ...
      <div className="mx-auto max-w-7xl px-6 md:px-10 py-12 pb-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 md:gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={item.name}>
                  <Link to={item.path} className="text-sm text-slate-500 hover:text-blue-600 transition-all ">{item.name}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-sm text-slate-500">Email: careerautoai@gmail.com</li>
              <li className="text-sm text-slate-500">Phone: +91 XXXXX XXXXX</li>
              <li>
                <Link to="/contact" className="text-sm text-slate-500 hover:text-blue-600 transition-all font-medium">
                  Live Support
                </Link>
              </li>
            </ul>
          ...
          <div className="flex flex-wrap justify-center gap-x-4 gap-y-2 text-xs text-slate-400">
            {[
              ...
              <React.Fragment key={item.name}>
                <Link to={item.path} className="hover:text-slate-900 dark:hover:text-white transition-all ">{item.name}</Link>
        ...
        <div className="my-6 border-t border-slate-300 dark:border-slate-700/60 pt-6 flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
          ...
          <div className="flex items-center gap-4 text-slate-400">
            <a href="#" className="hover:text-[#0077b5] transition-all " aria-label="LinkedIn">
            ...
            <a href="#" className="hover:text-slate-900 dark:hover:text-white transition-all " aria-label="GitHub">
            ...
            <a href="#" className="hover:text-[#ff0000] transition-all " aria-label="YouTube">
