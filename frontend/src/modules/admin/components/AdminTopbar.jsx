...
const AdminTopbar = () => {
  return (
    <header className="sticky top-0 z-50 w-full bg-white/60 dark:bg-[#080c10]/60 backdrop-blur-md border-b border-slate-200/50 dark:border-slate-800/50">
      <div className="max-w-[1600px] mx-auto w-full px-8 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2">
            <button className="relative size-11 flex items-center justify-center text-slate-500 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-2xl transition-all border border-transparent hover:border-slate-200 dark:hover:border-slate-700 group">
