              ...
              {loading ? (
                ...
                <tr key={c.id} className="hover:bg-slate-100 dark:hover:bg-slate-800/50 transition-colors">
                  <td className="px-6 py-4">
                    ...
                    >
                      <div className="size-10 rounded-xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center font-black text-blue-600 uppercase border border-slate-300 dark:border-slate-700">
                        {c.company_name?.[0] || 'C'}
                      </div>
                      <div>
