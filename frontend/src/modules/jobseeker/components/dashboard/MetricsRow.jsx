...
const MetricCard = ({ title, value, icon: Icon, color }) => (
  <div className="bg-white rounded-[12px] p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] border border-slate-100 flex items-center justify-between group hover:border-blue-200 transition-all">
    <div>
