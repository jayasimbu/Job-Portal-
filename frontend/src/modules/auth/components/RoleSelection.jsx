    ...
    <div className="flex flex-col gap-5 w-full max-w-md mx-auto">
      ...
      {roles.map((role) => (
        <button
          ...
          className={`flex items-center gap-4 p-4 transition-all rounded-2xl border-2 ${role.borderColor} ${role.hoverBorder} text-left group bg-slate-50 dark:bg-[#1a2632] shadow-sm hover:shadow-[0_15px_40px_rgba(37,99,235,0.08)] hover:scale-[1.02] active:scale-[0.98] outline-none focus:ring-4 focus:ring-blue-500/10`}
        >
