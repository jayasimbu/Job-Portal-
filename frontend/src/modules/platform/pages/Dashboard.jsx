...
const Dashboard = () => {
  ...
  return (
    <div className="w-full px-4 md:px-6 lg:px-10 xl:px-16 py-6 h-full flex flex-col overflow-y-auto overflow-x-hidden duration-700">
      {/* HEADER */}
      <header className="flex-shrink-0 mb-8 flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        {result && (
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-5 rounded-2xl shadow-xl shadow-blue-500/20 flex items-center gap-6 ">
          ...
          <section className="flex-1 min-h-0 p-4 md:p-6 bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-[#020617] border border-slate-200 dark:border-slate-800 rounded-3xl flex flex-col overflow-hidden shadow-sm transition hover:shadow-xl hover:-translate-y-1">
            ...
            {result ? (
                    ...
                    return (
                      <div key={i} className="space-y-1.5">
                        ...
                        <div className="h-2 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden shadow-inner">
                          <div className={`h-full ${c} rounded-full transition-all shadow-sm`} style={{ width: `${val}%` }} />
                        </div>
                      </div>
                    );
                  })}
              ...
              <div className="flex-1 flex flex-col items-center justify-center gap-6 min-h-0">
                <div className="flex items-center gap-4 bg-blue-50 dark:bg-blue-900/10 px-8 py-4 rounded-2xl border border-blue-100 dark:border-blue-800 shadow-sm ">
              ...
              <div className="flex-1 flex flex-col min-h-0">
                ...
                {error && (
                  <div className="mt-3 flex items-center justify-between p-4 bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-800 rounded-2xl ">
